...
<script>
    export default {
        ...
        methods: {
            getSupplierContacts () {
                return axios.get('/suppliers/ajax/' + this.supplier.id + '/contacts').then((response) => {
            ...
            store () {
                ...
                axios.post('/suppliers/ajax/' + this.supplier.id + '/contacts', this.creating.form).then(() => {
